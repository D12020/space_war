...
for i in range(800):
    ...
    stars.append(s)
# Images
ship_img = pygame.image.load('assets/images/playerShip2_orange.png')
ship_img2 = pygame.image.load('assets/images/playerShip2_orange-2.png')
ship_img3 = pygame.image.load('assets/images/playerShip2_orange-3.png')
ship_img4 = pygame.image.load('assets/images/playerShip2_orange-4.png')
ship_img5 = pygame.image.load('assets/images/playerShip2_orange-5.png')

laser_img = pygame.image.load('assets/images/laserGreen05.png')

hitmob_img = pygame.image.load('assets/images/spaceShips_002.png')

mob_img = pygame.image.load('assets/images/enemyBlack2.png')
mob_img1 = pygame.image.load('assets/images/enemyBlack2_dmg1.png')
mob_img2 = pygame.image.load('assets/images/enemyBlack2_dmg2.png')


bomb_img = pygame.image.load('assets/images/laserRed03.png')
...
def show_death_screen():
    death_text = FONT_LG.render("You Are Dead", 1, RED)
    screen.blit(explosion, [350, 350])
    screen.blit(death_text, [178, 275])
    screen.blit(Untitled, [325, 50])

def show_win_screen():
    wun_text = FONT_LG.render("You Have Won", 1, GREEN)
